...
// Library supports windows that can follow the cursor or are
// statically positioned.  If cursor movements are required, then the
// last argument must be 'true'.
...
// Accessor to the hover
win_hover_lib.prototype.get_hover_ref = function() {
    return this.js_box;
};
...
// Simple accessor--is the hover visible?
win_hover_lib.prototype.visible = function() {
    return (this.js_box.style.visibility == "visible");
};
